            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="store-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-registration<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" data-container="#tab-general" title="Св-во о гос. регистрации">Св-во о гос. регистрации:</span></label>
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][registration]" rows="5" placeholder="Св-во о гос. регистрации" id="input-registration<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['registration'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-сommercial-registry"><span data-toggle="tooltip" data-container="#tab-general" title="Регистрация в торговом реестре">Регистрация в торговом реестре</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_сommercial_registry" value="<?php echo $config_сommercial_registry; ?>" placeholder="Регистрация в торговом реестре" id="input-сommercial-registry" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_skype" value="<?php echo $config_skype; ?>" placeholder="Skype:" id="input-skype" class="form-control" />
                </div>
              </div>
              <div class="form-group">
