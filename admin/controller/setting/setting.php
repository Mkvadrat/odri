...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_registration'] = $this->request->post['config_langdata'][$front_language_id]['registration'];
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		if (isset($this->request->post['config_сommercial_registry'])) {
			$data['config_сommercial_registry'] = $this->request->post['config_сommercial_registry'];
		} else {
			$data['config_сommercial_registry'] = $this->config->get('config_сommercial_registry');
		}
