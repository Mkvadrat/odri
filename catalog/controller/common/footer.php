...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['owner_store'] = $this->config->get('config_owner');
		...
		// Menu
		$data['action'] = $this->url->link('product/special');
		$data['beauty'] = $this->url->link('information/posts');
		$data['special'] = $this->url->link('information/news');
		$data['manufacturer'] = $this->url->link('product/manufacturer');
		$data['payment'] = $this->url->link('information/information&information_id=6', '', true);
