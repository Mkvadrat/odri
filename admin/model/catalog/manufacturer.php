...
class ModelCatalogManufacturer extends Model {
    ...
    $front_language_id = $language_info['language_id'];
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', country = '" . $this->db->escape($data['country']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
    ...
    $front_language_id = $language_info['language_id'];
		...
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', country = '" . $this->db->escape($data['country']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
